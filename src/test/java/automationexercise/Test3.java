...
public class Test3 {
    ...
    public void selenium_test() {
        ...
        emailArea.sendKeys("ozerk@geldi.com");

        WebElement passwordArea = driver.findElement(By.xpath("//input[@data-qa='login-password']"));
        passwordArea.sendKeys("Ozerk");
        //7. Click 'login' button
        WebElement loginButton = driver.findElement(By.xpath("//button[@data-qa='login-button']"));
        loginButton.click();
        //8. Verify error 'Your email or password is incorrect!' is visible
        WebElement yourEmailOrPasswordIsIncorrect = driver.findElement(By.xpath("//p[contains(text(),'Your email or password is incorrect!')]"));
        System.out.println("yourEmailOrPasswordIsIncorrect.isDisplayed() = " + yourEmailOrPasswordIsIncorrect.isDisplayed());
